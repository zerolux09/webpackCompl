...
(function() {
  ...
  function d() {
    if (document.body) {
      var t = document.body,
        ...
        u = t.scrollHeight;
      if (
        ((l = document.compatMode.indexOf('CSS') >= 0 ? n : t),
        (e = t),
        s(),
        (i = !0),
        top != self)
        ...
        o = !0;
      else if (u > c && (t.offsetHeight <= c || n.offsetHeight <= c)) {
        var d = !1;
        if (
          ((n.style.height = 'auto'),
          setTimeout(function() {
            d ||
              ...
              ((d = !0),
              setTimeout(function() {
                (n.style.height = document.height + 'px'), (d = !1);
              }, 500));
          }, 10),
          l.offsetHeight <= c)
        ) {
        ...
        d = function(n) {
          for (var i = +new Date(), l = 0, c = 0, u = 0; u < f.length; u++) {
            var m = f[u],
              p = i - m.start,
              w = p >= a.animationTime,
              g = w ? 1 : p / a.animationTime;
            a.pulseAlgorithm && (g = C(g));
          ...
          s
            ...
            t || r || (f = []),
            f.length ? M(d, e, o / a.frameRate + 1) : (h = !1);
        };
      M(d, e, 0), (h = !0);
    }
  }
  function w(t) {
    var r = t.target,
      o =
        ...
        t.altKey ||
        t.metaKey ||
        (t.shiftKey && t.keyCode !== u.spacebar);
    if (
  ...
  function k(e, t) {
    for (var a = e.length; a--; ) g[y(e[a])] = t;
    return t;
  }
  function x(e) {
    var t = [],
  ...
  function C(e) {
    return e >= 1
      ...
      : e <= 0
      ? 0
      : (1 == a.pulseNormalize && (a.pulseNormalize /= T(1)), T(e));
  }
  var A =
