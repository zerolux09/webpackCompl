          ...
          (k.render = function(a, b, d) {
            ...
            this._onUpdate &&
              (0 > a &&
                ...
                this._startAt.render(a, !0, d),
              b ||
                ((this._totalTime !== r || f) && this._callback('onUpdate'))),
              this._cycle !== s &&
                (b ||
                  this._gc ||
...
b[c++] = {time: this._labels[a], name: a};
      ...
      _gsScope._gsDefine(
        ...
        function(a, b) {
          ...
          const Ta = (S.set3DTransformRatio = S.setTransformRatio = function(
            a,
          ) {
            let b;
            let c;
            ...
            ya(
              'transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,svgOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent,smoothOrigin',
              {
                parser: function(a, b, c, d, f, h, i) {
                  ...
                  let j;
                  const k =
                    i.scale && 'function' == typeof i.scale ? i.scale : 0;
                  ...
                  if (
                    ((D.skewType =
                      A.skewType || D.skewType || g.defaultSkewType),
                    (d._transform = D),
...
(c.s += c.c), (c.c = -c.c), (c = c._next);
        ...
        (i.invalidate = function() {
          return (
            this._notifyPluginsOfEnabled &&
              H._onPluginEvent('_onDisable', this),
      ...
      if (
        ...
        for (i in r) {
          r[i].func ||
            a.console.log('GSAP encountered missing dependency: ' + i);
        }
      }
      k = !1;
    })(
