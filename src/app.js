!function(t) {
const e={}; function i(a) {
if (e[a]) return e[a].exports; const n=e[a]={i: a, l: !1, exports: {}}; return t[a].call(n.exports, n, n.exports, i), n.l=!0, n.exports
}i.m=t, i.c=e, i.d=function(t, e, a) {
i.o(t, e)||Object.defineProperty(t, e, {enumerable: !0, get: a})
}, i.r=function(t) {
'undefined'!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t, Symbol.toStringTag, {value: 'Module'}), Object.defineProperty(t, '__esModule', {value: !0})
}, i.t=function(t, e) {
if (1&e&&(t=i(t)), 8&e) return t; if (4&e&&'object'==typeof t&&t&&t.__esModule) return t; const a=Object.create(null); if (i.r(a), Object.defineProperty(a, 'default', {enumerable: !0, value: t}), 2&e&&'string'!=typeof t) {
for (const n in t) {
i.d(a, n, function(e) {
return t[e]
}.bind(null, n));
...
'use strict'; Object.defineProperty(e, '__esModule', {value: !0}); const a=function() {
function t(t, e) {
for (let i=0; i<e.length; i++) {
const a=e[i]; a.enumerable=a.enumerable||!1, a.configurable=!0, 'value'in a&&(a.writable=!0), Object.defineProperty(t, a.key, a)
}
} return function(e, i, a) {
return i&&t(e.prototype, i), a&&t(e, a), e
}
}(); const n=r(i(1)); const o=r(i(2)); function r(t) {
return t&&t.__esModule?t:{default: t}
} const s=new(r(i(3)).default.GyroNorm); const l=function() {
function t() {
!function(t, e) {
...
} return a(t, [{key: 'addShader', value: function(t, e) {
const i=this.gl.createShader(e); if (this.gl.shaderSource(i, t), this.gl.compileShader(i), !this.gl.getShaderParameter(i, this.gl.COMPILE_STATUS)) throw new Error('Shader compile error: '+this.gl.getShaderInfoLog(i)); this.gl.attachShader(this.program, i)
}}, {key: 'resizeHandler', value: function() {
this.windowWidth=window.innerWidth, this.windowHeight=window.innerHeight, this.width=this.container.offsetWidth, this.height=this.container.offsetHeight, this.canvas.width=this.width*this.ratio, this.canvas.height=this.height*this.ratio, this.canvas.style.width=this.width+'px', this.canvas.style.height=this.height+'px'; let t=void 0; let e=void 0; this.height/this.width<this.imageAspect?(t=1, e=this.height/this.width/this.imageAspect):(t=this.width/this.height*this.imageAspect, e=1), this.uResolution.set(this.width, this.height, t, e), this.uRatio.set(1/this.ratio), this.uThreshold.set(this.hth, this.vth), this.gl.viewport(0, 0, this.width*this.ratio, this.height*this.ratio)
...
}}, {key: 'addTexture', value: function() {
this.gl; !function(t, e) {
for (var i=[], a=t.length, n=function() {
0===--a&&e(i)
}, o=0; o<a; ++o) {
const r=c(t[o], n); i.push(r)
}
}(this.imageURLs, this.start.bind(this))
}}, {key: 'start', value: function(t) {
const e=this.gl; this.imageAspect=t[0].naturalHeight/t[0].naturalWidth, console.log(this.imageAspect, '=aspect', this); for (let i=0; i<t.length; i++) {
...
} const n=this.gl.getUniformLocation(this.program, 'image0'); const o=this.gl.getUniformLocation(this.program, 'image1'); this.gl.uniform1i(n, 0), this.gl.uniform1i(o, 1), this.gl.activeTexture(this.gl.TEXTURE0), this.gl.bindTexture(this.gl.TEXTURE_2D, this.textures[0]), this.gl.activeTexture(this.gl.TEXTURE1), this.gl.bindTexture(this.gl.TEXTURE_2D, this.textures[1]), this.resize(), this.render()
}}, {key: 'gyro', value: function() {
const t=this; this.maxTilt=15; s.init({gravityNormalized: !0}).then(function() {
s.start(function(e) {
const i=e.do.gamma; const a=e.do.beta; t.mouseTargetY=m(a, -t.maxTilt, t.maxTilt)/t.maxTilt, t.mouseTargetX=-m(i, -t.maxTilt, t.maxTilt)/t.maxTilt
})
}).catch(function(t) {
console.log('not supported')
})
}}, {key: 'mouseMove', value: function() {
const t=this; document.addEventListener('mousemove', function(e) {
const i=t.windowWidth/2; const a=t.windowHeight/2; t.mouseTargetX=(i-e.clientX)/i, t.mouseTargetY=(a-e.clientY)/a
})
}}, {key: 'render', value: function() {
const t=((new Date).getTime()-this.startTime)/1e3; this.uTime.set(t), this.mouseX+=.05*(this.mouseTargetX-this.mouseX), this.mouseY+=.05*(this.mouseTargetY-this.mouseY), this.uMouse.set(this.mouseX, this.mouseY), this.billboard.render(this.gl), requestAnimationFrame(this.render.bind(this))
}}]), t
}(); function c(t, e) {
const i=new Image; return i.src=t, i.onload=e, i
} function h(t, e, i, a) {
this.name=t, this.suffix=e, this.gl=a, this.program=i, this.location=a.getUniformLocation(i, t)
} function u(t) {
const e=t.createBuffer(); t.bindBuffer(t.ARRAY_BUFFER, e), t.bufferData(t.ARRAY_BUFFER, u.verts, t.STATIC_DRAW)
} function m(t, e, i) {
return t==t&&(void 0!==i&&(t=t<=i?t:i), void 0!==e&&(t=t>=e?t:e)), t
}e.default=l, h.prototype.set=function() {
for (var t='uniform'+this.suffix, e=arguments.length, i=Array(e), a=0; a<e; a++)i[a]=arguments[a]; const n=[this.location].concat(i); this.gl[t].apply(this.gl, n)
...
'use strict'; let a; let n; 'function'==typeof Symbol&&Symbol.iterator; !function(t) {
function e(t) {
...
for (const e in u.orientation.data=t, u.orientation.callbacks)u.orientation.callbacks[e].call(this)
} function o(t) {
for (const e in u.motion.data=t, u.motion.callbacks)u.motion.callbacks[e].call(this)
} if (void 0===t.FULLTILT||null===t.FULLTILT) {
const r=Math.PI; const s=r/2; const l=2*r; var c=r/180; const h=180/r; var u={orientation: {active: !1, callbacks: [], data: void 0}, motion: {active: !1, callbacks: [], data: void 0}}; var m=!(!t.screen||!t.screen.orientation||void 0===t.screen.orientation.angle||null===t.screen.orientation.angle); var d=(m?t.screen.orientation.angle:t.orientation||0)*c; const v=s; const g=r; const f=l/3; const p=-s; var y={version: '0.5.3', getDeviceOrientation: function(t) {
return new Promise(function(e, a) {
const n=new y.DeviceOrientation(t); n.start(), new i(u.orientation).then(function() {
...
return new Promise(function(e, a) {
const n=new y.DeviceMotion(t); n.start(), new i(u.motion).then(function() {
...
let o; this.set=function(t, e, i, a) {
...
let t; let e; let i; let a; let n; let o; let r; let s; let l; let h; let u; let m; return function(d) {
...
}}; y.Quaternion.prototype={constructor: y.Quaternion, multiplyQuaternions: function() {
const t=new y.Quaternion; return function(e, i) {
const a=e.x; const n=e.y; const o=e.z; const r=e.w; const s=i.x; const l=i.y; const c=i.z; const h=i.w; return t.set(a*h+r*s+n*c-o*l, n*h+r*l+o*s-a*c, o*h+r*c+a*l-n*s, r*h-a*s-n*l-o*c), t
}
}(), normalize: function(t) {
let e=Math.sqrt(t.x*t.x+t.y*t.y+t.z*t.z+t.w*t.w); return 0===e?(t.x=0, t.y=0, t.z=0, t.w=1):(e=1/e, t.x*=e, t.y*=e, t.z*=e, t.w*=e), t
}, rotateByAxisAngle: function() {
let t; let e; let i=new y.Quaternion; const a=new y.Quaternion; return function(n, o, r) {
...
let h; this.elements=new Float32Array(9), this.identity=function() {
...
let t; let e; let i; let a; let n; let o; let r; let s; let l; return function(h) {
...
let t; let e; let i; let a; return function(n) {
...
}, y.RotationMatrix.prototype={constructor: y.RotationMatrix, multiplyMatrices: function() {
let t; let e; const i=new y.RotationMatrix; return function(a, n) {
...
const e=t.elements; const i=e[0]*e[4]*e[8]-e[0]*e[5]*e[7]-e[1]*e[3]*e[8]+e[1]*e[5]*e[6]+e[2]*e[3]*e[7]-e[2]*e[4]*e[6]; return e[0]/=i, e[1]/=i, e[2]/=i, e[3]/=i, e[4]/=i, e[5]/=i, e[6]/=i, e[7]/=i, e[8]/=i, t.elements=e, t
}, rotateByAxisAngle: function() {
let t; let e; let i=new y.RotationMatrix; const a=new y.RotationMatrix; let n=!1; return function(o, r, s) {
...
let t; let e; let i; return function(a) {
const n=a.w*a.w; const o=a.x*a.x; const c=a.y*a.y; const u=a.z*a.z; const m=n+o+c+u; const d=a.w*a.x+a.y*a.z; if (d>.499999*m)t=2*Math.atan2(a.y, a.w), e=s, i=0; else if ((1e-6-.5)*m>d)t=-2*Math.atan2(a.y, a.w), e=-s, i=0; else {
const v=n-o+c-u; const g=2*(a.w*a.z-a.x*a.y); const f=n-o-c+u; const p=2*(a.w*a.y-a.x*a.z); f>0?(t=Math.atan2(g, v), e=Math.asin(2*d/m), i=Math.atan2(p, f)):(t=Math.atan2(-g, -v), e=-Math.asin(2*d/m), e+=0>e?r:-r, i=Math.atan2(-p, -f))
...
}, y.Euler.prototype={constructor: y.Euler, rotateByAxisAngle: function() {
let t=new y.RotationMatrix; return function(e, i, a) {
...
this.options=e||{}; let i=0; let a=0; if (this.alphaOffsetScreen=0, this.alphaOffsetDevice=void 0, 'game'===this.options.type) {
var n=function(e) {
...
}.bind(this); t.addEventListener('deviceorientation', n, !1)
...
}.bind(this); t.addEventListener('deviceorientation', o, !1)
}
}, y.DeviceOrientation.prototype={constructor: y.DeviceOrientation, start: function(e) {
...
const t=new y.Euler; const e=new y.RotationMatrix; const i=new y.Quaternion; return function() {
const a=u.orientation.data||{alpha: 0, beta: 0, gamma: 0}; let n=a.alpha; return this.alphaOffsetDevice&&(e.setFromEuler(this.alphaOffsetDevice), e.rotateZ(-this.alphaOffsetScreen), t.setFromRotationMatrix(e), t.alpha<0&&(t.alpha+=360), t.alpha%=360, n-=t.alpha), t.set(n, a.beta, a.gamma), i.setFromEuler(t), i
}
...
const t=new y.Euler; const e=new y.RotationMatrix; return function() {
const i=u.orientation.data||{alpha: 0, beta: 0, gamma: 0}; let a=i.alpha; return this.alphaOffsetDevice&&(e.setFromEuler(this.alphaOffsetDevice), e.rotateZ(-this.alphaOffsetScreen), t.setFromRotationMatrix(e), t.alpha<0&&(t.alpha+=360), t.alpha%=360, a-=t.alpha), t.set(a, i.beta, i.gamma), e.setFromEuler(t), e
}
...
let t; const e=new y.Euler; return function() {
...
}, _alphaAvailable: !1, _betaAvailable: !1, _gammaAvailable: !1, isAvailable: function(t) {
switch (t) {
case this.ALPHA: return this._alphaAvailable; case this.BETA: return this._betaAvailable; case this.GAMMA: return this._gammaAvailable
}
}, ALPHA: 'alpha', BETA: 'beta', GAMMA: 'gamma'}, y.DeviceMotion=function(t) {
this.options=t||{}
}, y.DeviceMotion.prototype={constructor: y.DeviceMotion, start: function(e) {
...
const t=u.motion.data&&u.motion.data.acceleration?u.motion.data.acceleration:{x: 0, y: 0, z: 0}; const e={}; switch (d) {
case v: e.x=-t.y, e.y=t.x; break; case g: e.x=-t.x, e.y=-t.y; break; case f: case p: e.x=t.y, e.y=-t.x; break; default: e.x=t.x, e.y=t.y
} return e.z=t.z, e
}, getScreenAdjustedAccelerationIncludingGravity: function() {
const t=u.motion.data&&u.motion.data.accelerationIncludingGravity?u.motion.data.accelerationIncludingGravity:{x: 0, y: 0, z: 0}; const e={}; switch (d) {
case v: e.x=-t.y, e.y=t.x; break; case g: e.x=-t.x, e.y=-t.y; break; case f: case p: e.x=t.y, e.y=-t.x; break; default: e.x=t.x, e.y=t.y
} return e.z=t.z, e
}, getScreenAdjustedRotationRate: function() {
const t=u.motion.data&&u.motion.data.rotationRate?u.motion.data.rotationRate:{alpha: 0, beta: 0, gamma: 0}; const e={}; switch (d) {
case v: e.beta=-t.gamma, e.gamma=t.beta; break; case g: e.beta=-t.beta, e.gamma=-t.gamma; break; case f: case p: e.beta=t.gamma, e.gamma=-t.beta; break; default: e.beta=t.beta, e.gamma=t.gamma
} return e.alpha=t.alpha, e
}, getLastRawEventData: function() {
return u.motion.data||{}
}, _accelerationXAvailable: !1, _accelerationYAvailable: !1, _accelerationZAvailable: !1, _accelerationIncludingGravityXAvailable: !1, _accelerationIncludingGravityYAvailable: !1, _accelerationIncludingGravityZAvailable: !1, _rotationRateAlphaAvailable: !1, _rotationRateBetaAvailable: !1, _rotationRateGammaAvailable: !1, isAvailable: function(t) {
switch (t) {
case this.ACCELERATION_X: return this._accelerationXAvailable; case this.ACCELERATION_Y: return this._accelerationYAvailable; case this.ACCELERATION_Z: return this._accelerationZAvailable; case this.ACCELERATION_INCLUDING_GRAVITY_X: return this._accelerationIncludingGravityXAvailable; case this.ACCELERATION_INCLUDING_GRAVITY_Y: return this._accelerationIncludingGravityYAvailable; case this.ACCELERATION_INCLUDING_GRAVITY_Z: return this._accelerationIncludingGravityZAvailable; case this.ROTATION_RATE_ALPHA: return this._rotationRateAlphaAvailable; case this.ROTATION_RATE_BETA: return this._rotationRateBetaAvailable; case this.ROTATION_RATE_GAMMA: return this._rotationRateGammaAvailable
}
}, ACCELERATION_X: 'accelerationX', ACCELERATION_Y: 'accelerationY', ACCELERATION_Z: 'accelerationZ', ACCELERATION_INCLUDING_GRAVITY_X: 'accelerationIncludingGravityX', ACCELERATION_INCLUDING_GRAVITY_Y: 'accelerationIncludingGravityY', ACCELERATION_INCLUDING_GRAVITY_Z: 'accelerationIncludingGravityZ', ROTATION_RATE_ALPHA: 'rotationRateAlpha', ROTATION_RATE_BETA: 'rotationRateBeta', ROTATION_RATE_GAMMA: 'rotationRateGamma'}, t.FULLTILT=y
}
}(window), n={GyroNorm: function() {
function t(t) {
return Math.round(t*Math.pow(10, A))/Math.pow(10, A)
} function e() {
let e={}; e=b?v.getScreenAdjustedEuler():v.getFixedFrameEuler(); const i=g.getScreenAdjustedAcceleration(); const n=g.getScreenAdjustedAccelerationIncludingGravity(); const o=g.getScreenAdjustedRotationRate(); let r=0; y===a?r=0>(r=e.alpha-h)?360-Math.abs(r):r:r=e.alpha; const s={do: {alpha: t(r), beta: t(e.beta), gamma: t(e.gamma), absolute: v.isAbsolute()}, dm: {x: t(i.x), y: t(i.y), z: t(i.z), gx: t(n.x), gy: t(n.y), gz: t(n.z), alpha: t(o.alpha), beta: t(o.beta), gamma: t(o.gamma)}}; return p&&(s.dm.gx*=u, s.dm.gy*=u, s.dm.gz*=u), s
} function i(t) {
x&&('string'==typeof t&&(t={message: t, code: 0}), x(t))
} var a='game'; const n='world'; const o='deviceorientation'; const r='acceleration'; const s='accelerationinludinggravity'; const l='rotationrate'; let c=null; var h=0; var u=0; let m=!1; let d=!1; var v=null; var g=null; let f=50; var p=!0; var y=a; var A=2; var x=null; var b=!1; const E=function(t) {}; return E.GAME=a, E.WORLD=n, E.DEVICE_ORIENTATION=o, E.ACCELERATION=r, E.ACCELERATION_INCLUDING_GRAVITY=s, E.ROTATION_RATE=l, E.prototype.init=function(t) {
t&&t.frequency&&(f=t.frequency), t&&t.gravityNormalized&&(p=t.gravityNormalized), t&&t.orientationBase&&(y=t.orientationBase), t&&'number'==typeof t.decimalCount&&t.decimalCount>=0&&(A=parseInt(t.decimalCount)), t&&t.logger&&(x=t.logger), t&&t.screenAdjusted&&(b=t.screenAdjusted); const e=new FULLTILT.getDeviceOrientation({type: y}).then(function(t) {
v=t
}); const i=(new FULLTILT.getDeviceMotion).then(function(t) {
...
t(e())
}, f), void(m=!0)):void i({message: 'GyroNorm is not initialized yet. First call the "init()" function.', code: 1})
...
const e=v.getScreenAdjustedEuler(); const i=g.getScreenAdjustedAcceleration(); const a=g.getScreenAdjustedAccelerationIncludingGravity(); const n=g.getScreenAdjustedRotationRate(); switch (t) {
case o: return e.alpha&&null!==e.alpha&&e.beta&&null!==e.beta&&e.gamma&&null!==e.gamma; case r: return i&&i.x&&i.y&&i.z; case s: return a&&a.x&&a.y&&a.z; case l: return n&&n.alpha&&n.beta&&n.gamma; default: return {deviceOrientationAvailable: e.alpha&&null!==e.alpha&&e.beta&&null!==e.beta&&e.gamma&&null!==e.gamma, accelerationAvailable: i&&i.x&&i.y&&i.z, accelerationIncludingGravityAvailable: a&&a.x&&a.y&&a.z, rotationRateAvailable: n&&n.alpha&&n.beta&&n.gamma}
}
