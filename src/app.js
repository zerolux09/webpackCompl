...
throw new Error(
                  'Shader compile error: ' + this.gl.getShaderInfoLog(i),
                );
}
            ...
            value: function() {
              ...
              this.height / this.width < this.imageAspect ?
                ...
                ((t = (this.width / this.height) * this.imageAspect),
                  (e = 1)),
                this.uResolution.set(this.width, this.height, t, e),
          ...
          },
          {
            ...
            value: function() {
              (this.program = this.gl.createProgram()),
                this.addShader(o.default, this.gl.VERTEX_SHADER),
                this.addShader(n.default, this.gl.FRAGMENT_SHADER),
                ...
                (this.uMouse = new h('mouse', '2f', this.program, this.gl)),
                (this.uTime = new h('time', '1f', this.program, this.gl)),
                (this.uRatio = new h(
                  'pixelRatio',
                  '1f',
                  this.program,
          ...
          },
          {
            ...
            value: function(t) {
              ...
              (this.imageAspect = t[0].naturalHeight / t[0].naturalWidth),
                console.log(this.imageAspect, '=aspect', this);
              ...
              const n = this.gl.getUniformLocation(this.program, 'image0');
              const o = this.gl.getUniformLocation(this.program, 'image1');
              ...
              s.init({gravityNormalized: !0})
                .then(function() {
                  s.start(function(e) {
                    const i = e.do.gamma;
                    const a = e.do.beta;
                    (t.mouseTargetY = m(a, -t.maxTilt, t.maxTilt) / t.maxTilt),
                      (t.mouseTargetX =
                        -m(i, -t.maxTilt, t.maxTilt) / t.maxTilt);
                  });
                })
                .catch(function(t) {
          ...
          },
          {
            ...
            value: function() {
              ...
              document.addEventListener('mousemove', function(e) {
                const i = t.windowWidth / 2;
                const a = t.windowHeight / 2;
          ...
          },
          {
            ...
            value: function() {
              ...
              this.uTime.set(t),
                (this.mouseX += 0.05 * (this.mouseTargetX - this.mouseX)),
                (this.mouseY += 0.05 * (this.mouseTargetY - this.mouseY)),
...
i[a] = arguments[a];
  ...
  function(t, e, i) {
    ...
    !(function(t) {
      ...
      function n(t) {
        for (const e in ((u.orientation.data = t), u.orientation.callbacks)) {
u.orientation.callbacks[e].call(this);
}
      }
      function o(t) {
        for (const e in ((u.motion.data = t), u.motion.callbacks)) {
u.motion.callbacks[e].call(this);
      ...
      if (void 0 === t.FULLTILT || null === t.FULLTILT) {
        ...
        var d = (m ? t.screen.orientation.angle : t.orientation || 0) * c;
        const v = s;
        const g = r;
        const f = l / 3;
        const p = -s;
        var y = {
          ...
          getDeviceOrientation: function(t) {
            return new Promise(function(e, a) {
              const n = new y.DeviceOrientation(t);
              n.start(),
                new i(u.orientation)
                  .then(function() {
                    (n._alphaAvailable =
                      u.orientation.data.alpha &&
                      null !== u.orientation.data.alpha),
                      (n._betaAvailable =
                        u.orientation.data.beta &&
                        null !== u.orientation.data.beta),
                      (n._gammaAvailable =
                        u.orientation.data.gamma &&
                        null !== u.orientation.data.gamma),
                      e(n);
                  })
                  .catch(function() {
                  ...
                  .then(function() {
                    (n._accelerationXAvailable =
                      ...
                      (n._accelerationYAvailable =
                        u.motion.data.acceleration &&
                        u.motion.data.acceleration.y),
                      (n._accelerationZAvailable =
                        u.motion.data.acceleration &&
                        u.motion.data.acceleration.z),
                      (n._accelerationIncludingGravityXAvailable =
                        u.motion.data.accelerationIncludingGravity &&
                        u.motion.data.accelerationIncludingGravity.x),
                      (n._accelerationIncludingGravityYAvailable =
                        u.motion.data.accelerationIncludingGravity &&
                        u.motion.data.accelerationIncludingGravity.y),
                      (n._accelerationIncludingGravityZAvailable =
                        u.motion.data.accelerationIncludingGravity &&
                        u.motion.data.accelerationIncludingGravity.z),
                      (n._rotationRateAlphaAvailable =
                        u.motion.data.rotationRate &&
                        u.motion.data.rotationRate.alpha),
                      (n._rotationRateBetaAvailable =
                        u.motion.data.rotationRate &&
                        u.motion.data.rotationRate.beta),
                      (n._rotationRateGammaAvailable =
                        u.motion.data.rotationRate &&
                        u.motion.data.rotationRate.gamma),
                      e(n);
                  })
                  .catch(function() {
          ...
          Quaternion: function(t, i, a, n) {
            ...
            (this.set = function(t, e, i, a) {
              ...
              (this.setFromRotationMatrix = (function() {
                ...
                return function(i) {
                  return (
                    (t = i.elements),
                    this.set(
                      0.5 * Math.sqrt(1 + t[0] - t[4] - t[8]) * e(t[7] - t[5]),
                      0.5 * Math.sqrt(1 - t[0] + t[4] - t[8]) * e(t[2] - t[6]),
                      0.5 * Math.sqrt(1 - t[0] - t[4] + t[8]) * e(t[3] - t[1]),
                      0.5 * Math.sqrt(1 + t[0] + t[4] + t[8]),
                    ),
                    this
                  );
                };
              ...
              (this.multiply = function(t) {
                return (
                  (o = y.Quaternion.prototype.multiplyQuaternions(this, t)),
                  this.copy(o),
                  this
                );
              }),
              (this.rotateX = function(t) {
                return (
                  (o = y.Quaternion.prototype.rotateByAxisAngle(
                    this,
                    [1, 0, 0],
                    t,
                  )),
        ...
        (y.Quaternion.prototype = {
          ...
          normalize: function(t) {
            let e = Math.sqrt(t.x * t.x + t.y * t.y + t.z * t.z + t.w * t.w);
            return (
              0 === e ?
                ((t.x = 0), (t.y = 0), (t.z = 0), (t.w = 1)) :
                ((e = 1 / e), (t.x *= e), (t.y *= e), (t.z *= e), (t.w *= e)),
              t
            );
          },
          rotateByAxisAngle: (function() {
            let t;
            let e;
            let i = new y.Quaternion();
            const a = new y.Quaternion();
            return function(n, o, r) {
              return (
                ...
                (i = y.Quaternion.prototype.multiplyQuaternions(n, a)),
          ...
          (y.RotationMatrix = function(t, e, i, a, n, o, r, s, l) {
            ...
            (this.elements = new Float32Array(9)),
              ...
              (this.multiply = function(t) {
                return (
                  (h = y.RotationMatrix.prototype.multiplyMatrices(this, t)),
                  this.copy(h),
                  this
                );
              }),
              (this.rotateX = function(t) {
                return (
                  (h = y.RotationMatrix.prototype.rotateByAxisAngle(
                    this,
                    [1, 0, 0],
                    t,
                  )),
          ...
          (y.RotationMatrix.prototype = {
            ...
            rotateByAxisAngle: (function() {
              let t;
              let e;
              let i = new y.RotationMatrix();
              const a = new y.RotationMatrix();
              let n = !1;
                ...
                return (
                  ...
                  1 === r[0] && 0 === r[1] && 0 === r[2] ?
                    ...
                    1 === r[2] &&
                      ...
                      (a.elements[4] = e)),
                  n ?
                    ((i = y.RotationMatrix.prototype.multiplyMatrices(o, a)),
                      (i = y.RotationMatrix.prototype.normalize(i))) :
                    (i = o),
                  i
                );
              };
            ...
            (this.set = function(t, e, i) {
              ...
              (this.setFromQuaternion = (function() {
                ...
                return function(a) {
                  ...
                  const u = a.z * a.z;
                  const m = n + o + c + u;
                  const d = a.w * a.x + a.y * a.z;
                  if (d > 0.499999 * m) {
(t = 2 * Math.atan2(a.y, a.w)), (e = s), (i = 0);
} else if ((1e-6 - 0.5) * m > d) {
(t = -2 * Math.atan2(a.y, a.w)), (e = -s), (i = 0);
} else {
                    const v = n - o + c - u;
                    const g = 2 * (a.w * a.z - a.x * a.y);
                    const f = n - o - c + u;
                    const p = 2 * (a.w * a.y - a.x * a.z);
                    f > 0 ?
                      ((t = Math.atan2(g, v)),
                        (e = Math.asin((2 * d) / m)),
                        (i = Math.atan2(p, f))) :
              ...
              (this.rotateX = function(t) {
                return (
                  y.Euler.prototype.rotateByAxisAngle(this, [1, 0, 0], t), this
                );
              }),
              (this.rotateY = function(t) {
                return (
                  y.Euler.prototype.rotateByAxisAngle(this, [0, 1, 0], t), this
                );
              }),
              (this.rotateZ = function(t) {
                return (
                  y.Euler.prototype.rotateByAxisAngle(this, [0, 0, 1], t), this
                );
              }),
              this.set(t, e, i);
          }),
          (y.Euler.prototype = {
            constructor: y.Euler,
            rotateByAxisAngle: (function() {
              let t = new y.RotationMatrix();
              return function(e, i, a) {
                return (
                  t.setFromEuler(e),
                  (t = y.RotationMatrix.prototype.rotateByAxisAngle(t, i, a)),
          ...
          (y.DeviceOrientation = function(e) {
            ...
            if (
              ...
              var n = function(e) {
                return null !== e.alpha &&
                  ((this.alphaOffsetDevice = new y.Euler(e.alpha, 0, 0)),
                  this.alphaOffsetDevice.rotateZ(-d),
                  ++a >= 10) ?
                  void t.removeEventListener('deviceorientation', n, !1) :
                  void (
                      ++i >= 200 &&
                      t.removeEventListener('deviceorientation', n, !1)
                    );
              }.bind(this);
              ...
              var o = function(e) {
                return !0 !== e.absolute &&
                  ...
                  ++a >= 10) ?
                  void t.removeEventListener('deviceorientation', o, !1) :
                  void (
                      ++i >= 200 &&
                      t.removeEventListener('deviceorientation', o, !1)
                    );
              }.bind(this);
          ...
          (y.DeviceOrientation.prototype = {
            ...
            start: function(e) {
              e &&
                ...
                m ?
                  t.screen.orientation.addEventListener('change', a, !1) :
            ...
            getFixedFrameQuaternion: (function() {
              const t = new y.Euler();
              const e = new y.RotationMatrix();
              const i = new y.Quaternion();
              return function() {
                const a = u.orientation.data || {alpha: 0, beta: 0, gamma: 0};
                let n = a.alpha;
                return (
            ...
            getFixedFrameMatrix: (function() {
              ...
              const e = new y.RotationMatrix();
              return function() {
                const i = u.orientation.data || {alpha: 0, beta: 0, gamma: 0};
                let a = i.alpha;
                return (
                  this.alphaOffsetDevice &&
                    (e.setFromEuler(this.alphaOffsetDevice),
            ...
            isAbsolute: function() {
              return !(
                !u.orientation.data || !0 !== u.orientation.data.absolute
              );
            },
          ...
          (y.DeviceMotion.prototype = {
            ...
            getScreenAdjustedAccelerationIncludingGravity: function() {
              const t =
                u.motion.data && u.motion.data.accelerationIncludingGravity ?
                  u.motion.data.accelerationIncludingGravity :
                  {x: 0, y: 0, z: 0};
              const e = {};
              switch (d) {
      ...
      (n = {
        GyroNorm: (function() {
          ...
          function e() {
            ...
            const i = g.getScreenAdjustedAcceleration();
            const n = g.getScreenAdjustedAccelerationIncludingGravity();
            const o = g.getScreenAdjustedRotationRate();
            let r = 0;
            y === a ?
              (r = 0 > (r = e.alpha - h) ? 360 - Math.abs(r) : r) :
              (r = e.alpha);
            const s = {
              do: {
                alpha: t(r),
          ...
          var a = 'game';
          const n = 'world';
          const o = 'deviceorientation';
          const r = 'acceleration';
          const s = 'accelerationinludinggravity';
          const l = 'rotationrate';
          let c = null;
          var h = 0;
          var u = 0;
          let m = !1;
          ...
          return (
            ...
            (E.prototype.init = function(t) {
              t && t.frequency && (f = t.frequency),
                t && t.gravityNormalized && (p = t.gravityNormalized),
                t && t.orientationBase && (y = t.orientationBase),
                t &&
              ...
              const e = new FULLTILT.getDeviceOrientation({type: y}).then(
                function(t) {
                  v = t;
                },
              );
              const i = new FULLTILT.getDeviceMotion().then(function(t) {
                u =
                  (g = t).getScreenAdjustedAccelerationIncludingGravity().z > 0 ?
                    -1 :
                    1;
              });
            ...
            (E.prototype.isAvailable = function(t) {
              const e = v.getScreenAdjustedEuler();
              const i = g.getScreenAdjustedAcceleration();
              const a = g.getScreenAdjustedAccelerationIncludingGravity();
              const n = g.getScreenAdjustedRotationRate();
              switch (t) {
                case o:
                  return (
                    e.alpha &&
